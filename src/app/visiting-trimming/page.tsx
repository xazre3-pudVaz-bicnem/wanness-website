...
const suitableFor = [
  ...
  },
  {
    ...
    text: "店舗型サロンと違い、ほかのわんちゃんとの接触を避けられるため、ストレスやノミ・ダニ、感染症のリスク低減につながります。音や環境の変化に敏感な子もご相談ください。",
  },
  {
    title: "皮膚や身体の状態も見てほしい方",
    text: "出張トリミングでも、身体の左右差・可動域の確認とスキンケアを含むベーシックケアトリミングとして施術します。より深いケアのオプションや、ホームケアのご提案も可能です。わんちゃんの気になる仕草や変化、疑問なども、お気軽にご相談ください。",
  },
  {
    title: "生活環境も含めて相談したい方",
    text: "お困りであれば、普段過ごしているお部屋の様子も踏まえて、日常のケアや過ごし方を一緒に考えられるのは訪問型ならではです。",
  },
];
...
const preparations = [
  {
    title: "駐車スペース",
    text: "軽自動車で伺います。ご自宅の駐車スペースのご協力をお願いします。近隣のコインパーキングを利用する場合は、駐車料金のご負担をお願いしています。",
  },
  {
    title: "コンセント付近のスペース",
    text: "トリミングテーブル・カットスペースとして、コンセント付近のスペースをお借りします。シャンプーの際は浴室やお湯もお借りする場合があります。",
  },
  {
    title: "タオル数枚",
        ...
        <div className="order-1 md:order-2">
          ...
          <Reveal>
            <div className="space-y-4 text-sm leading-loose text-ink/85 md:text-base">
              ...
              <p>
                わんnessの出張トリミングは、身体と皮膚の細かな確認、ケアまでを含む
