...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "「わんこと人が、元気に、心地よく。」出張トリミングとボディケアを通して、愛犬の健やかな毎日を支えます。",
    url: "/about",
...
const commitments = [
  {
    ...
    text: "わんnessのトリミングは、キレイに整えるだけの時間ではありません。カウンセリングで普段の様子を伺い、身体の左右差や関節の動かしやすさ、皮膚や被毛の状態を確認しながら進めます。トリミングの日が、愛犬の身体を見つめ直す日になるように。",
  },
  {
    title: "自然な身体で、その子らしく",
      ...
      <section className="relative mx-auto w-full max-w-5xl px-4 py-14 md:py-20">
        ...
        <Reveal className="text-center">
          ...
          <div className="mx-auto mt-8 max-w-3xl space-y-4 text-left text-sm leading-loose text-ink/85 md:text-base">
            ...
            <p>
              見た目を整えるだけのトリミングではなく、日々のケアを通じて愛犬の身体・皮膚・動きの状態を確認し、飼い主さまと一緒に健康管理を支えていくこと。それが、わんnessの役割だと考えています。
            </p>
            <p>
          ...
          <div>
            ...
            <Reveal>
              <div className="space-y-4 text-sm leading-loose text-ink/85 md:text-base">
                ...
                <p>
                  わんnessは日常的なケアを通じて、身体や皮膚の変化に気づくきっかけをつくり、必要なときには主治医の先生へ相談していただけるようお伝えする。そんな、動物医療と毎日の暮らしの間を支える存在でありたいと考えています。
                </p>
                <p>
                  治療中のわんちゃんは、必要に応じて主治医へご相談のうえでご利用ください。
                </p>
              </div>
            </Reveal>
          </div>
