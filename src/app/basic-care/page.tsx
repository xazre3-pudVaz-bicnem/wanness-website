...
const flow = [
  ...
  },
  {
    ...
    text: "その日の身体や皮膚の様子をお伝えし、ご自宅でできる簡単なケアをご提案します。気になる変化があった場合は、かかりつけの獣医師さんへの相談をおすすめすることもあります。",
  },
];
        ...
        <div>
          ...
          <Reveal>
            <div className="space-y-4 text-sm leading-loose text-ink/85 md:text-base">
              <p>
                一般的なトリミングでは、シャンプーやカット、爪切りなどを通して清潔を保ち、愛犬ちゃんが快適に過ごせるようケアを行います。
              </p>
              <p>
              ...
              <p>
                トリミングのたびに身体の状態をより繊細に確認することで、小さな変化に気づくきっかけが生まれます。気になる変化があれば飼い主さまへ共有し、必要に応じてかかりつけの獣医師さんへの相談をおすすめしています。
              </p>
            </div>
          </Reveal>
        </div>
        ...
        <div className="mx-auto w-full max-w-5xl px-4 py-14 md:py-20">
          ...
          <Reveal className="mt-6">
            <p className="rounded-2xl border border-sky/30 bg-skylight/50 p-5 text-xs leading-relaxed text-ink/75 md:text-sm">
              ※ベーシックケアトリミングに含まれる整体・マッサージケアは、日々の健康管理を目的としたものであり、病気やケガの診断・治療などの医療行為ではありません。治療中のわんちゃんは、必要に応じてかかりつけの獣医師さんへご相談ください。
            </p>
          </Reveal>
        </div>
      </section>
